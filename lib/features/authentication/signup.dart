                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      OslerInput(
                        label:
                            getTranslated(context, AppString.register_full_name)
                                .toString(),
                        ...
                        validator: (String? value) {
                          if (value!.isEmpty) {
                            return getTranslated(
                                    context, AppString.please_enter_full_name)
                                .toString();
                          }
                          return null;
                        },
                      ...
                      OslerDropdown(
                        label: '',
                        hint: getTranslated(
                                context, AppString.register_select_gender_hint)
                            .toString(),
                        value: _genderSelect,
                        items: gender,
                      ...
                      OslerButton(
                        text: getTranslated(context, AppString.register_button)
                            .toString(),
                        onPressed: () {
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        getTranslated(
                                context, AppString.register_all_ready_account)
                            .toString(),
                        style: TextStyle(
                            fontSize: 14,
