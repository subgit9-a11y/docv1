...
void main() async {
  final String testPatientId =
      'PATIENT-PRIYA-TEST'; // The exact patient ID we generated earlier!

  final String url =
      'https://astra.ayureze.in/api/v1/astra-fill/patient/$testPatientId/latest';

  print(
      "=========================================================================");
  print(
      "🚀 DOCTOR APP <-> ASTRA COMPANION (20-PARAM) CONNECTION DIAGNOSTIC 🚀");
  print(
      "=========================================================================\n");
  ...
  try {
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      print(
          '✅ SUCCESS! Doctor App successfully securely tapped into Astra Fill!\n');
