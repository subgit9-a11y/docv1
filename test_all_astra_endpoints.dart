...
void main() async {
  ...
  final List<Map<String, dynamic>> endpoints = [
    ...
    },
    {
      ...
      'method': 'POST',
      'body': {"text": "Patient has 102 fever and headache."}
    },
    {
      'name': 'Patient Search',
  ...
  for (var endpoint in endpoints) {
    ...
    try {
      ...
      HttpClientResponse response =
          await request.close().timeout(Duration(seconds: 15));
      ...
      if (response.statusCode >= 200 && response.statusCode < 300) {
        ...
        print(
            '⚠️ REACHABLE BUT RETURNED ${response.statusCode} (Expected if missing Auth/Data).');
  ...
  print(
      "=========================================================================");
  print(
      "AUDIT COMPLETE: $successCount reachable endpoints, $failCount failed endpoints.");
  print(
      "=========================================================================");
}
